...
//        port(9090);
//
//        // 3. WILDCARD CORS CONFIGURATION (Fixes "Failed to fetch")
...
//            res.header("Access-Control-Allow-Origin", "*"); // <--- ALLOWS ANYONE
...
//        // 4. Routes
//
//        // Test Route (Visit http://localhost:9090/ in browser to verify)
//        get("/", (req, res) -> "TaskBoard API is running!");
//
//        // POST: Create Task
//        post("/api/tasks", (Request req, Response res) -> {
//            // Log for debugging
//            System.out.println("Received POST request: " + req.body());
//
...
//            System.out.println("Received PUT request for ID: " + idStr);
//
//            try {
...
//            // Get all columns from the board via the service
//            java.util.List<Column> columns = service.getColumns();
//            java.util.List<TaskResponse> result = new java.util.ArrayList<>();
//
//            if (columns != null) {
...
//                            break;
//                        default:
//                            // fallback for any future/extra columns
...
//
//            res.type("application/json");
//            // If there are no tasks, result is just [] and Gson will serialize that
