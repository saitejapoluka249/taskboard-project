...
//
///**
// * Very simple file-based persistence.
// * Format:
// * TASK;id;title;description;priority;status;dueDate
// */
...
//                // override default state based on status
...
//            // if something goes wrong, return an empty board
//            return board;
//        }
//
//        return board;
...
//                    sb.append(t.getStatusName()).append(";");
//                    sb.append(t.getDueDate() == null ? "" : t.getDueDate().toString());
//                    writer.write(sb.toString());
//                    writer.newLine();
//                }
//            }
//        } catch (IOException e) {
//            // ignore in this simple example
//        }
//    }
//
